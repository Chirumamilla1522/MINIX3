 ...
 *				exit_proc				     *
 *===========================================================================*/
void exit_proc(rmp, exit_status, dump_core) register struct mproc *rmp; /* pointer to the process to be terminated */
...
int dump_core;                                                          /* flag indicating whether to dump core */
{
  ...
  if (procgrp != 0)
    check_sig(-procgrp, SIGHUP, FALSE /* ksig */);
}

/*===========================================================================*
 *				exit_restart				     *
 *===========================================================================*/
void exit_restart(rmp, dump_core) struct mproc *rmp; /* pointer to the process being terminated */
int dump_core;                                       /* flag indicating whether to dump core */
{
...
int do_waitpid()
{
  ...
  if (pidarg == 0)
    pidarg = -mp->mp_procgrp; /* pidarg < 0 ==> proc grp */
 ...
 *				zombify					     *
 *===========================================================================*/
static void zombify(rmp) struct mproc *rmp;
{
 ...
 *				check_parent				     *
 *===========================================================================*/
static void check_parent(child, try_cleanup) struct mproc *child; /* tells which process is exiting */
 ...
 *				tell_parent				     *
 *===========================================================================*/
static void tell_parent(child) register struct mproc *child; /* tells which process is exiting */
{
  int mp_parent;
  struct mproc *parent;
 ...
 *				tell_tracer				     *
 *===========================================================================*/
static void tell_tracer(child) struct mproc *child; /* tells which process is exiting */
{
  int mp_tracer;
  struct mproc *tracer;
 ...
 *				tracer_died				     *
 *===========================================================================*/
static void tracer_died(child) struct mproc *child; /* process being traced */
{
 ...
 *				cleanup					     *
 *===========================================================================*/
static void cleanup(rmp) register struct mproc *rmp; /* tells which process is exiting */
{
